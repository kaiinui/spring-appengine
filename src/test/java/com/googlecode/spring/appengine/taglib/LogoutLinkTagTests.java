 ...
 */
public class LogoutLinkTagTests extends AbstractTagTests {

    private LogoutLinkTag tag;

    @Before
    public void setUp() throws Exception {
        super.setUp();
        tag = new LogoutLinkTag();
    ...
    public void testRendersLoginLink() throws Exception {
        ...
        assertEquals("<a href=\"/_ah/logout?continue=%2Fmy-destination-url\"></a>", output);
    }
    ...
    public void testRendersLoginLinkWithDynamicAttributes() throws Exception {
        ...
        tag.doEndTag();
        String output = ((MockHttpServletResponse) pageContext.getResponse()).getContentAsString();
        assertEquals("<a href=\"/_ah/logout?continue=%2Fmy-destination-url\" id=\"my-id\" class=\"my-class\"></a>", output);
    }
}
